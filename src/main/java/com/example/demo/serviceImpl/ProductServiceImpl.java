...
public class ProductServiceImpl implements ProductService {
	...
	public void addProduct(ProductDto dto) {
		...
		Category category = categoryRepo.findById(dto.getCategoryId())
				.orElseThrow(() -> new ProductServiceException("Category not found with id: " + dto.getCategoryId(),
						HttpStatus.NOT_FOUND));

		Product product = ProductMapper.mapToProduct(dto, category);
	...
	public List<ProductDto> getAllProduct() {
		...
		List<ProductDto> productDto = products.stream().map(p -> ProductMapper.mapToProductDto(p))
